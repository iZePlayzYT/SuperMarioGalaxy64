...
const LevelScript level_fourth_floor_entry[] = {
	...
	AREA(1, fourth_floor_area_1),
		...
		OBJECT(/*model*/ MODEL_PLAYER_LOCK_SWITCH_YELLOW_LOCKED_PIPE, /*pos*/ -1281, -110, 2270,/*angle*/ 0, -190, 0, /*behParam*/ 2, /*beh*/ bhvCharacterSwitchPipeWarioLocked),
		OBJECT(/*model*/ MODEL_PLAYER_LOCK_SWITCH_YELLOW_UNLOCKED_PIPE, /*pos*/ -1281, -110, 2270,/*angle*/ 0, -190, 0, /*behParam*/ 2, /*beh*/ bhvCharacterSwitchPipeWarioUnlocked),
