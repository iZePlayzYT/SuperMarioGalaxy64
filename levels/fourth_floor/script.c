...
const LevelScript level_fourth_floor_entry[] = {
	...
	AREA(1, fourth_floor_area_1),
		...
		OBJECT(/*model*/ MODEL_PLAYER_LOCK_SWITCH_PIPE, /*pos*/  36, -135, -533,/*angle*/ 0, 0, 0, /*behParam*/ 0, /*beh*/ bhvCharacterSwitchPipe),
		OBJECT(/*model*/ MODEL_PLAYER_LOCK_SWITCH_PIPE, /*pos*/ 376, -135, -533,/*angle*/ 0, 0, 0, /*behParam*/ 1, /*beh*/ bhvCharacterSwitchPipe),
		OBJECT(/*model*/ MODEL_PLAYER_LOCK_SWITCH_PIPE, /*pos*/ 716, -135, -533,/*angle*/ 0, 0, 0, /*behParam*/ 2, /*beh*/ bhvCharacterSwitchPipe),
