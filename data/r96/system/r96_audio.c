...
void r96_play_character_charge_sound(struct MarioState *m) {
    if (!(m->flags & MARIO_MARIO_SOUND_PLAYED)) {
        switch (random_u16() % 3) {
            case 0: r96_play_character_sound(m, R96_MARIO_HELLO, R96_LUIGI_HELLO, R96_WARIO_HELLO); break;
            case 1: r96_play_character_sound(m, R96_MARIO_THROW, R96_LUIGI_THROW, R96_WARIO_THROW); break;
            case 2: r96_play_character_sound(m, R96_MARIO_WAHA, R96_LUIGI_WAHA, R96_WARIO_WAHA); break;
        }
...
void r96_play_character_jump_sound(struct MarioState *m) {
    if (!(m->flags & MARIO_MARIO_SOUND_PLAYED)) {
        if (m->action == ACT_TRIPLE_JUMP || m->action == ACT_WARIO_TRIPLE_JUMP) {
            switch (random_u16() % 3) {
                case 0: r96_play_character_sound(m, R96_MARIO_WAHA, R96_LUIGI_WAHA, R96_WARIO_WAHA); break;
                case 1: r96_play_character_sound(m, R96_MARIO_YIPPEE, R96_LUIGI_YIPPEE, R96_WARIO_YIPPEE); break;
                case 2: r96_play_character_sound(m, R96_MARIO_YAHOO, R96_LUIGI_YAHOO, R96_WARIO_YAHOO); break;
            }
        } else {
            switch (random_u16() % 3) {
                case 0: r96_play_character_sound(m, R96_MARIO_YAH, R96_LUIGI_YAH, R96_WARIO_YAH); break;
                case 1: r96_play_character_sound(m, R96_MARIO_WAH, R96_LUIGI_WAH, R96_WARIO_WAH); break;
                case 2: r96_play_character_sound(m, R96_MARIO_HOO, R96_LUIGI_HOO, R96_WARIO_HOO); break;
            }
        }
        m->flags |= MARIO_MARIO_SOUND_PLAYED;
    }
    ...
    if (jukebox != -1) {
        if (jukebox >= 57) {
            ...
            if (!dynos_jingle_is_playing(jingle)) {
                dynos_jingle_stop();
                dynos_jingle_play(jingle);
            }
            if (gMenuMode != -1) {
                softenJingleVolume = 0.2f;
            } else {
                softenJingleVolume = 1.f;
            }
        } else {
